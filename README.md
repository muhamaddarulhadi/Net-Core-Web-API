...
1. [Create web APIs with ASP.NET Core](https://learn.microsoft.com/en-us/aspnet/core/web-api/?view=aspnetcore-7.0)
...
4. [ASP.Net Core: Add Web API to existing Project](https://www.aspsnippets.com/Articles/ASPNet-Core-Add-Web-API-to-existing-Project.aspx)
5. [ASP.Net Core: Call (Consume) Web API using HttpClient](https://www.aspsnippets.com/Articles/ASPNet-Core-Call-Consume-Web-API-using-HttpClient.aspx)
6. [Create Web API in Visual Studio 2019 step by step](https://www.aspsnippets.com/Articles/Create-Web-API-in-Visual-Studio-2019-step-by-step.aspx)
7. [ASP.Net Core Web API example](https://www.aspsnippets.com/Articles/ASPNet-Core-Web-API-example.aspx)
8. [ASP.Net Core: Call (Consume) Web API using JavaScript XmlHttpRequest (XHR) and AJAX](https://www.aspsnippets.com/Articles/ASPNet-Core-Call-Consume-Web-API-using-JavaScript-XmlHttpRequest-XHR-and-AJAX.aspx)
9. [Call ASP.Net Core Web API using jQuery AJAX](https://www.aspsnippets.com/Articles/Call-ASPNet-Core-Web-API-using-jQuery-AJAX.aspx)
10. [Using WebClient in ASP.Net MVC](https://www.aspsnippets.com/Articles/Using-WebClient-in-ASPNet-MVC.aspx)
11. [Create Web API in .Net Core](https://www.aspsnippets.com/Articles/Create-Web-API-in-Net-Core.aspx)
12. [Create Web API in ASP.Net Core](https://www.aspsnippets.com/Articles/Create-Web-API-in-ASPNet-Core.aspx)
13. [Using .Net Core Web API with Entity Framework](https://www.aspsnippets.com/Articles/Using-Net-Core-Web-API-with-Entity-Framework.aspx)
14. [ASP.Net Core: Web API Entity Framework Database First Approach](https://www.aspsnippets.com/Articles/ASPNet-Core-Web-API-Entity-Framework-Database-First-Approach.aspx)
15. [ASP.Net Core Razor Pages: Call (Consume) external API inside Handler Method](https://www.aspsnippets.com/Articles/ASPNet-Core-Razor-Pages-Call-Consume-external-API-inside-Handler-Method.aspx)
16. [Call (Consume) external API in ASP.Net Core Razor Pages](https://www.aspsnippets.com/Articles/Call-Consume-external-API-in-ASPNet-Core-Razor-Pages.aspx)
17. [Using WebClient in ASP.Net Core Razor Pages](https://www.aspsnippets.com/Articles/Using-WebClient-in-ASPNet-Core-Razor-Pages.aspx)
18. [ASP.Net Core Razor Pages: Upload Files using Web API](https://www.aspsnippets.com/Articles/ASPNet-Core-Razor-Pages-Upload-Files-using-Web-API.aspx)
19. [ASP.Net Core: Multipart/Form-Data file upload in Web API](https://www.aspsnippets.com/Articles/ASPNet-Core-MultipartForm-Data-file-upload-in-Web-API.aspx)
20. [Return HTTP Status Code from Web API in ASP.Net Core](https://www.aspsnippets.com/Articles/Return-HTTP-Status-Code-from-Web-API-in-ASPNet-Core.aspx)
21. [Create Web API in Visual Studio 2022 step by step](https://www.aspsnippets.com/Articles/Create-Web-API-in-Visual-Studio-2022-step-by-step.aspx)
22. [ASP.Net Core Razor Pages: Step by Step Web API Tutorial for Beginners](https://www.aspsnippets.com/Articles/ASPNet-Core-Razor-Pages-Step-by-Step-Web-API-Tutorial-for-Beginners.aspx)
